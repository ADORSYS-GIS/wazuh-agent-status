...
ADORSYS_UPDATE_SCRIPT_URL=${ADORSYS_UPDATE_SCRIPT_URL:-"https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-agent-status/refs/heads/refactor/split-linux-macos-scripts/scripts/linux/adorsys-update.sh"}
