...
<p class="section-desc">Get the application running and understand how your data is secured.</p>

<div class="docs-grid">
  <a href="installation.html" class="docs-card">
    <div class="docs-card-title">Installation & Setup</div>
    <p class="docs-card-desc">Step-by-step guides for installing the client on Windows, Linux, and macOS.</p>
  </a>

  <a href="troubleshooting.html" class="docs-card">
    <div class="docs-card-title">Troubleshooting & FAQs</div>
    <p class="docs-card-desc">Common solutions for agent disconnections and log file locations.</p>
  </a>

  <a href="security-privacy.html" class="docs-card">
    <div class="docs-card-title">Security & Privacy</div>
    <p class="docs-card-desc">Understand how local data is fetched and exactly what is sent to the AI provider.</p>
  </a>
</div>
