...
// checkServiceStatus checks the status of Wazuh agent and its connection on Unix systems
...
// updateAgent updates the Wazuh agent on Unix and streams progress to the client
...
// handlePrereleaseUpdate handles the prerelease update process for Unix
...
func getLocalVersion() string {
	...
	if err != nil {
		log.Printf("Failed to get version file path: %v", err)
		return "Unknown"
	}
